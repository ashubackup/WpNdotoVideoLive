...
<body>
                            ...
                            <div class="cusform">
                                ...
                                <form id="joinForm" onsubmit="return validateForm(event)">
                                    <div class="form-group mb-3">
                                        <input type="checkbox" id="termsCheckbox" required> I agree to the <a href="term.html">Terms and Conditions</a>
                                    </div>
    ...
    <script>
        function validateForm(event) {
            ...
            window.location.replace("http://wap.zero9.co.za/ndoto/join.php?s=stream_r5");
