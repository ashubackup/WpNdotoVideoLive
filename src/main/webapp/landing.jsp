                        ...
                        <div class="left_content">
                            <div class="cusform">
                                ...
                                <!-- <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="number"  id="ani" class="form-control" placeholder="Enter your phone number : eg. 812xxxxxx" maxlength="11" minlength="9" pattern="\d*" required>
                                </div> -->
...
<!--                                 </div> -->
                                <div class="submit-btn">
                                    <button type="submit" onclick="keydown()" class="btn px-4 text-uppercase btn-primary submit-btn-cus">Join</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
//     		window.location.href="http://sdp.smartcalltech.co.za/Traffic/83334dd0-0314-4a25-a979-413b5d4f9f98";
