...
<head>
    ...
    <title>NdotoStream | Thank you</title>
                    ...
                    <div class="col-md-7 col-lg-6 col-xl-6 py-3">
                        <div class="inner_content text-center px-3 py-4 p-md-5 bg-white rounded">
                            <div class="inner_content_img text-center mb-4">
                                <img src="images/logo.png" alt="cb" class="img-fluid" />
                            </div>
                            <%
                            ...
                            <div class="submit-btn mt-4">
                                <button onclick="window.location.href='redirect?type=offnet&msisdn=<%=ani %>&ref=<%=ref %>'" class="btn w-100 px-4 btn-block text-uppercase btn-primary submit-btn-cus">Try Again</button>
                            </div>
                        </div>
                    </div>
                </div>
